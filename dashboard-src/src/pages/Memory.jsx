      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div className="card">
          ...
          <div className="card-value-row">
            <span className="card-value">{memory.messages || 0}</span>
            <span className="text-xs text-muted font-semibold">条消息</span>
          </div>
        ...
        <div className="card">
          ...
          <div className="card-value-row">
            <span className="card-value">{memory.learnedMembers || 0}</span>
            <span className="text-xs text-muted font-semibold">位群友</span>
          </div>
        ...
        <div className="card">
          ...
          <div className="card-value-row">
            <span className="card-value">{memory.learnedGroups || 0}</span>
            <span className="text-xs text-muted font-semibold">个群</span>
          </div>
